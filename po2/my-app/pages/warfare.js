            ...
            <div data-reactid="238">
                <section className='css-136ow7o'>
                    <div className='css-j34mpb'>
                        <video autoPlay loop muted className='css-dq71mr' poster="https://www.callofduty.com/content/dam/atvi/callofduty/cod-touchui/blog/body/mwii/MWII-LAUNCH-MP-003-.jpg" id="vid" >
                            <source src="https://www.activision.com/cdn/cod/cod-3-20.mp4" type="video/mp4">
                            </source>
                        </video>
                    </div>
                    ...
                    <div className='css-15di1cn'>
                        ...
                        <div className='css-1yndg9k'>
                            <div className='css-51r16h'>
                                ...
                                <span className='css-1rtysnp'></span>
                                <span className='css-luwnau'></span>
                                <span className='css-zh2z45'></span>
                                <span className='css-aca8iq'></span>
                ...
                <section className='css-p1dprw'>
                    <div className='css-15di1cn'>
                        ...
                        <div className='css-1yndg9k'>
                            <div className='css-51r16h'>
                                <span className='css-57g655'></span>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className='css-p1dprw'>
                    <div className='css-15di1cn'>
                        ...
                        <div className='css-1yndg9k'>
                            <div className='css-51r16h'>
                                <span className='css-kdb8sc'></span>
                ...
                <div className='css-13bn7r8'>

                    <ul className='css-1hg2lzs'>

                        <li className='css-tlpo5e '>
                            <section className='css-7m85p4'>
                                <div className='css-1h4didn'></div>
                                <div className='css-1byn0p5'>
                                    <h1 className='css-u4qi6p'></h1>
                                    <hr className="css-1v3bl1y" data-reactid="354"></hr>
                        ...
                        <li className='css-13e19bh carousel-control-prev '>
                            <section className='css-eofkfk'>
                                <div className='css-1h4didn'></div>
                                <div className='css-1byn0p5'>

                                    <h1 className='css-u4qi6p'></h1>
                                    <hr className="css-1v3bl1y" data-reactid="354"></hr>
                                    <h3 className='css-hl68yx'></h3>
                                </div>
                            </section>
                        </li>
                        ...
                        <li className='css-13e19bh   '>
                            <section className='css-1a9ake3'>
                                <div className='css-1h4didn'></div>
                                <div className='css-1byn0p5'>
                                    <h1 className='css-u4qi6p'></h1>
                                    <hr className="css-1v3bl1y" data-reactid="354"></hr>
                                    <h3 data-css-hl68yx="" data-reactid="364"></h3>
                                </div>
                    ...
                    {/* <ul className='css-hsw4b1'>
                        <li className='css-il3peo'>
                            <span className='css-1mswlf3'>
                                <span className='css-n7qrt1' data-reactid="431"></span>
                                <span data-reactid="432" className='css-53j11p' ></span>
                            </span>

                        </li>

                        <li className='css-sv3oam'>
                            <span className='css-1mswlf3'>
                                <span className='css-n7qrt1' data-reactid="431"></span>
                                <span data-reactid="432" className='css-53j11p' ></span>
                            </span>
                ...
                <section className='css-p1dprw'>
                    <div className='css-15di1cn'>
                        ...
                        <div className='css-1yndg9k'>
                            <div className='css-51r16h'>
                                <span className='css-57g6555'></span>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className='css-p1dprw'>
                    <div className='css-15di1cn'>
                        ...
                        <div className='css-1yndg9k'>
                            <div className='css-51r16h'>
                                <span className='css-kdb8scc'></span>
