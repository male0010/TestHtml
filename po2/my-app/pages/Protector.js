    ...
    return (
        <div className='stylee'>
            <article className='_2jwgMFDkSKSr-foNIF_7f9'>
                ...
                <Image className='_2yWxQtB7xJRsFyvEkRLyW' src={bb} alt="#" />

                <section className='PGIVj9NTYRWLNncBni330'>
                    <header>
                        <h3 className='_2rgIsi3tJYjXp_0uWKfrBZ'>FEBRUARY 23, 2023</h3>
                        <h1>SUPPORT VETERANS WITH THE CALL OF DUTY ENDOWMENT (C.O.D.E.) PROTECTOR PACK FOR CALL OF DUTY®: MODERN WARFARE® II AND CALL OF DUTY®: WARZONE™ 2.0 </h1>
                    </header>
                    <div className='nOk1K0s0zezhHodo4OuM3'>
                        <div>
                            ...
                            <ul>
                                ...
                                <li className='lli'>“Duty Calls” Sniper Rifle Blueprint
                                </li>
                                <li className='lli'>“Frontline Stripes” Vehicle Skin
                                </li>
                                <li className='lli'>“Ready for Anything” Animated Calling Card
                                </li>
                                <li className='lli'>“Tagged” Weapon Charm
                                </li>
                                <li className='lli'>“Seeing Double” Static Animated Emblem
                                </li>
                                <li className='lli'>1 Hour Double XP Token
                                </li>
                            ...
                            <p>Hutch has always been good at two things — football and video games. For obvious reasons (hes built like a house and moves like a panther), he was encouraged to pursue the former. The eldest of three boys, Hutch was a protective brother and a natural leader with a tendency to push limits — in life, in the classroom, and on the field. Hutch never gave up his love for gaming and his knack for building computers, his mind, and his body for peak performance. His hard work and dedication paid off when he was rewarded with a scholarship to play college ball and pursue a major in computer science, artificial intelligence, and data engineering.</p>
