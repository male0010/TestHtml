...
export default function header() {
  ...
  return (
    ...
    <div className="container overflow-hidden text-center">
        <select className='col-10 col-sm-2' onChange={(event) => {
        ...
        {filterdata?.map((item, index) => {
            return (
              <div  className='container text-center my-5 ' key= {item.id_data}>
                     <div className='row row-cols-2 row-cols-lg-5 g-2 g-lg-3'>
                        ...
                        <div class="modal fade p-0" id={"exampleModal" + item.id_data} tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
