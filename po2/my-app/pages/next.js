    ...
    return (
        ...
        <div className='stylee'> 
            <article className='_2jwgMFDkSKSr-foNIF_7f9'>
                ...
                <Image className='_2yWxQtB7xJRsFyvEkRLyW' src={neee} alt="#" />

                <section className='PGIVj9NTYRWLNncBni330'>
                    <header>
                        <h3 className='_2rgIsi3tJYjXp_0uWKfrBZ'>FEBRUARY 14, 2023</h3>
                        <h1> NEXT: ANNOUNCING CALL OF DUTY®: WARZONE™ MOBILE, REDEFINING BATTLE ROYALE FOR GAMERS ON THE GO</h1>
                    </header>
                    <div className='nOk1K0s0zezhHodo4OuM3'>
                        ...
                        <ul>
                            ...
                            <p>Leveraging new unified technology across Call of Duty: Modern Warfare II, Call of Duty: Warzone 2.0 and Call of Duty: Warzone Mobile, players can share many social features (like friends and chat channels) and cross-progression enabling a shared Battle Pass and more for a connected Call of Duty experience. </p>
                            <p>Built for mobile devices to ensure an amazing handheld experience, Call of Duty: Warzone Mobile is set to feature mobile-specific events, playlists, and content as well as deep control customization options to support both Call of Duty veterans and new recruits alike.</p>
                            ...
                            <h5>Pre-register Now for in-game Rewards!</h5>
